#!/usr/bin/env bash
# build.sh — compile NoNap.app from source with the Command Line Tools only.
#
...
#
# Usage:
#   ./build.sh                      # build into ./build/NoNap.app
...
echo "   ./macos/install.sh to install the app and grant together."
